...
func CurlAction(id int) *Action {
	...
	/* 127.0.0.1:8080/api/v1/action/id

	    [root@localhost ~]# curl 127.0.0.1:8080/api/v1/action/1
	    {
	        "id":1,
	         "uic":"dev",
	         "url":"",
	...
	*/
	...
	token, _ := json.Marshal(map[string]string{
		"name": "falcon-alarm",
		"sig":  g.Config().Api.PlusApiToken, /*"plus_api_token": "default-token-used-in-server-side"*/
